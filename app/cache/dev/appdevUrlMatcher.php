...
class appdevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (rtrim($pathinfo, '/') === '/create') {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'acme_blog_default_create');
            }

            return array (  '_controller' => 'Acme\\BlogBundle\\Controller\\DefaultController::createAction',  '_route' => 'acme_blog_default_create',);
        }

        // acme_blog_default_show
        if (0 === strpos($pathinfo, '/show') && preg_match('#^/show/(?<id>[^/]+)$#s', $pathinfo, $matches)) {
            return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'Acme\\BlogBundle\\Controller\\DefaultController::showAction',  'requirements' =>   array (    'id' => '\\d+',  ),)), array('_route' => 'acme_blog_default_show'));
        }

        // _security_login
        if ($pathinfo === '/login') {
            return array (  '_controller' => 'Acme\\BlogBundle\\Controller\\SecurityController::loginAction',  '_route' => '_security_login',);
        }
        ...
        if (rtrim($pathinfo, '/') === '/admin') {
            ...
            return array (  '_controller' => 'Acme\\BlogBundle\\Controller\\AdminController::indexAction',  '_route' => 'admin_home',);
        }

        // acme_demo
        if ($pathinfo === '/contact') {
            return array (  '_controller' => 'Acme\\DemoBundle\\Controller\\DemoController::contactAction',  '_route' => 'acme_demo',);
        }
